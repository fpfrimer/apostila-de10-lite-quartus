...
Na etapa de dispositivo, a tela pode aparecer inicialmente com outra família selecionada, como na Figura~\ref{fig:selecao-dispositivo}. Selecione a família \texttt{MAX 10} para trabalhar com a DE10-Lite e digite \texttt{10M50DAF484C6GES} em \textit{Name Filter}. No entanto, essa não é a melhor forma de configurar o projeto. Existe uma opção mais prática, que é selecionar a placa diretamente, como mostrado na próxima etapa.

\imagemquartus{0.90}{image6.png}{Tela de seleção de família, dispositivo e placa.}{fig:selecao-dispositivo}

Alternativamente, na aba \textit{Board}, selecione a placa \textit{MAX 10 DE10-Lite}, como indicado na Figura~\ref{fig:selecao-placa}. Essa tela também possui a opção \textit{Create top-level design file}.
